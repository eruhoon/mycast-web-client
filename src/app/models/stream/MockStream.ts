    ...
    external: [
      {
        ...
        title: '리호진',
        description:
          '[생]호진 " 모데카이저 승률 100% ^^ 잡음 " 신입 MID 다이아 켠왕 3일차 LOL',
      ...
      },
      {
        ...
        nickname: 'YTN',
        thumbnail:
          'https://thumb.kakaocdn.net/dn/live_image/snapshot/873179579b985817_ss.jpg?t=157690209',
        onair: true,
        title: 'YTN',
      ...
      },
      {
        ...
        icon:
          'https://static-cdn.jtvnw.net/jtv_user_pictures/f170344d-7a60-47fa-8be6-a74e803fcf12-profile_image-300x300.jpg',
        nickname: 'BeyondTheSummit',
        title: 'BeyondTheSummit',
        description:
          'RERUN: TNC Predator vs Geek Fam Game 2 - DreamLeague S13 SEA Qualifiers: Group Stage',
        url: 'https://player.twitch.tv/?channel=beyondthesummit',
        onair: true,
        viewer: 562,
        thumbnail:
          'https://static-cdn.jtvnw.net/previews-ttv/live_user_beyondthesummit-200x150.jpg?1576902101566',
      },
      {
        result: true,
        platform: 'twitch',
        keyid: 'jmjdoc',
        icon:
          'https://static-cdn.jtvnw.net/jtv_user_pictures/adb1fcda-ef31-4c66-9ce1-d89e5fdbaf9a-profile_image-300x300.png',
        nickname: '칸데르니아',
        title: '칸데르니아',
        description: '림왈도',
        ...
        viewer: 797,
        thumbnail:
          'https://static-cdn.jtvnw.net/previews-ttv/live_user_jmjdoc-200x150.jpg?1576902101566',
      },
      {
        result: true,
        platform: 'twitch',
        keyid: 'jyw_zz',
        icon:
          'https://static-cdn.jtvnw.net/jtv_user_pictures/b40e53f6-cb01-46e5-8db4-95b044e4ed0c-profile_image-300x300.jpeg',
        nickname: '영우쿤',
        title: '영우쿤',
        description: 'ジーナ ボイド',
        ...
        viewer: 89,
        thumbnail:
          'https://static-cdn.jtvnw.net/previews-ttv/live_user_jyw_zz-200x150.jpg?1576902101566',
      },
      {
        result: true,
        platform: 'twitch',
        keyid: 'maknoonlol',
        icon:
          'https://static-cdn.jtvnw.net/jtv_user_pictures/3672c556-07a5-461c-bfdf-743e5e56f98c-profile_image-300x300.jpg',
        nickname: '막눈_',
        title: '막눈_',
        ...
        viewer: 5,
        thumbnail:
          'https://static-cdn.jtvnw.net/previews-ttv/live_user_maknoonlol-200x150.jpg?1576902101566',
      },
    ],
  };
}
