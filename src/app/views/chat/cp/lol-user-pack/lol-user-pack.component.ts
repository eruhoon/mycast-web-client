...
export class LolUserPackComponent extends ChatPackDirective implements OnInit {
  ...
  public constructor(injector: Injector, private mLinkPopup: LinkPopupService) {
    super(injector);
    this.mName = '';
    this.mLevel = 0;
    this.mIcon = '';
  ...
  public getTierText(): string {
    return this.mTierText;
  }
  ...
  public getMostChamps(): ChampParam[] {
    return this.mMostChamps;
  }
