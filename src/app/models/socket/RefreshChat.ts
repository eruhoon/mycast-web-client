...
export class RefreshChat implements Chat {
    ...
    public getSender(): ChatSender { return this.mSender; }

    public getMessages(): ChatMessage[] { return this.mMessages; }
}
...
class RefreshChatSender implements ChatSender {
    ...
    public getNickname(): string { return this.mDto.nickname; }

    public getLevel(): number { return this.mDto.level; }

    public getIcon(): string { return this.mDto.icon; }
    ...
    private isLegacyBot(): boolean { return this.mDto.level === 100; }
}
