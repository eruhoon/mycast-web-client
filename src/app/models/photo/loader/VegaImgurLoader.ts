...
class ImgurDtoAdapter implements Photo {
  ...
  public getHash(): string {
    return this.mImgurDto.id;
  }
  public getUrl(): string {
    return this.mImgurDto.link;
  }
  public getWidth(): number {
    return this.mImgurDto.width;
  }
  public getHeight(): number {
    return this.mImgurDto.height;
  }
  public getMimeType(): string {
    return this.mImgurDto.type;
  }
  public getRegDate(): Date {
    return new Date(this.mImgurDto.datetime);
  }
  public getViewer(): number {
    return this.mImgurDto.views;
  }
